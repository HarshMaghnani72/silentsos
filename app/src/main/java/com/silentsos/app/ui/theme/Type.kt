...
val provider = GoogleFont.Provider(
    ...
    certificates = com.silentsos.app.R.array.com_google_android_gms_fonts_certs
)
...
val ManropeFontFamily = FontFamily(
    ...
    Font(googleFont = ManropeFont, fontProvider = provider, weight = FontWeight.Black),
)
...
val SilentSOSTypography = Typography(
    // Display
